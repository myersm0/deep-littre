...
@testset "committed development store" begin
	...
	@testset "resolution through the committed store" begin
		...
		@test coverage["sublemma"].population_size == 473
		@test coverage["voice_variant"].population_size == 473
		@test coverage["qualification_scope"].population_size == 473
		@test coverage["bare_qualification"].population_size == 473
	end
end
